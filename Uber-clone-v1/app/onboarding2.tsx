...
const onboarding2 = () => {
  return (
    <View style={className`flex-1 p-5 gap-5`}>
      ...
      <Image source={require('../assets/onboarding2.png')} style={className`h-[350px] w-[350px]`}/>
      ...
      <Link href='/onboarding3' style={className`bg-[#0286FF] p-3 w-[350px] rounded-full text-center text-white`}>
      Next
      </Link>
    </View>
  )
